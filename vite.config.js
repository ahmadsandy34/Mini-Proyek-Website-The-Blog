...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "The Blog - LumosBlog",
        short_name: "The Blog",
        description:
          "This is the blog page of LumosBlog. Enjoy reading our blog posts! If you enjoy our blog posts, please subscribe to our newsletter to receive the latest news and updates.",
        theme_color: "#ffffff",
